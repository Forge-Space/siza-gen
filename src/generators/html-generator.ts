...
export class HtmlGenerator extends BaseGenerator {
  ...
  generateProject(
    ...
    files.push({
      path: 'package.json',
      content: this.createPackageJson(projectName, {}, devDeps),
    });
...
`,
    ...
    const fontFamily = designContext.typography?.fontFamily ?? 'Inter, system-ui, sans-serif';
    files.push({
      path: 'src/style.css',
  ...
  <body class="min-h-screen bg-background text-foreground">
    <main class="mx-auto max-w-4xl px-4 py-12">
      ...
      <p class="mt-2 text-muted-foreground">
        Vanilla HTML + Tailwind project scaffolded by Siza.
      </p>
    </main>
...
`,
    ...
    files.push({
      path: 'README.md',
      content: `# ${projectName}\n\nVanilla HTML + Tailwind CSS project generated by Siza.\n\n## Getting Started\n\n\`\`\`bash\nnpm install\nnpm run dev\n\`\`\`\n`,
    });
