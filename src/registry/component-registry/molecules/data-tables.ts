...
export const dataTableSnippets: IComponentSnippet[] = [
  ...
  <table className="w-full caption-bottom text-sm">
    ...
    <tbody className="divide-y">
      <tr className="hover:bg-muted/50 transition-colors">
        ...
        <td className="px-4 py-3">
          <span className="inline-flex items-center rounded-full bg-success/10 px-2 py-1 text-xs font-medium text-success dark:text-success ring-1 ring-inset ring-success/20">Active</span>
        </td>
    ...
    tailwindClasses: {
      ...
      td: 'px-4 py-3',
      badge:
        'inline-flex items-center rounded-full bg-success/10 px-2 py-1 text-xs font-medium text-success dark:text-success ring-1 ring-inset ring-success/20',
    },
    a11y: {
      roles: ['table'],
    ...
    <table className="w-full caption-bottom text-sm">
      ...
      <tbody className="divide-y">
        <tr className="hover:bg-muted/50 transition-colors">
          ...
          <td className="px-4 py-3">
            <span className="inline-flex items-center rounded-md bg-destructive/10 px-2 py-1 text-xs font-medium text-destructive dark:text-destructive/70 ring-1 ring-inset ring-destructive/20">High</span>
          </td>
        ...
        <tr className="hover:bg-muted/50 transition-colors">
          ...
          <td className="px-4 py-3">
            <span className="inline-flex items-center rounded-md bg-primary/10 px-2 py-1 text-xs font-medium text-primary dark:text-primary/70 ring-1 ring-inset ring-primary/20">Medium</span>
          </td>
