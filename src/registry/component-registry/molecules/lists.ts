...
export const listSnippets: IComponentSnippet[] = [
  ...
  <label className="flex items-start gap-3 rounded-lg border bg-card p-4 transition-colors hover:bg-accent cursor-pointer group">
    ...
    <span className="inline-flex items-center rounded-full bg-destructive/10 px-2 py-1 text-xs font-medium text-destructive dark:text-destructive ring-1 ring-inset ring-destructive/20">High</span>
  </label>
  <label className="flex items-start gap-3 rounded-lg border bg-card p-4 transition-colors hover:bg-accent cursor-pointer group">
  ...
  <label className="flex items-start gap-3 rounded-lg border bg-card p-4 transition-colors hover:bg-accent cursor-pointer group">
    ...
    tailwindClasses: {
      ...
      badge:
        'inline-flex items-center rounded-full bg-destructive/10 px-2 py-1 text-xs font-medium text-destructive dark:text-destructive ring-1 ring-inset ring-destructive/20',
    },
    a11y: {
      roles: [],
  ...
  <li className="relative">
    ...
    <div className="flex flex-col gap-1">
      <div className="flex items-center gap-2">
        ...
        <span className="inline-flex items-center rounded-full bg-accent/10 px-2 py-0.5 text-xs font-medium text-accent-foreground dark:text-accent-foreground ring-1 ring-inset ring-accent/20">Completed</span>
      </div>
  ...
  <li className="relative">
    ...
    tailwindClasses: {
      ...
      badge:
        'inline-flex items-center rounded-full bg-accent/10 px-2 py-0.5 text-xs font-medium text-accent-foreground dark:text-accent-foreground ring-1 ring-inset ring-accent/20',
    },
    a11y: {
      roles: ['minimal-editorial', 'listitem'],
