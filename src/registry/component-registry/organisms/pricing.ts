  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-2xl text-center">
      ...
      <div className="mt-8 flex items-center justify-center gap-3">
        ...
        <span className="inline-flex items-center rounded-full bg-success/10 px-2 py-0.5 text-xs font-medium text-success dark:bg-success/10 dark:text-success/70">Save 20%</span>
      </div>
    </div>
          ...
          <div className="flex items-start justify-between gap-4 rounded-lg border bg-accent p-4">
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex items-center rounded-md bg-success/10 px-2 py-0.5 text-xs font-medium text-success dark:bg-success/10 dark:text-success/70">Included</span>
              </div>
