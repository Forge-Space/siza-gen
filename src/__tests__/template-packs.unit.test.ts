...
import { registerPack, getPack, getAllPacks, searchPacks } from '../registry/template-packs/index.js';
import { initializePacks } from '../registry/template-packs/init.js';
import type { ITemplatePack } from '../registry/template-packs/types.js';
