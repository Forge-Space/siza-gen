...
import { classifyPromptPair, classifyPromptText } from '../feedback/prompt-classifier.js';
import { extractSkeleton, hashSkeleton, fingerprint, isPromotable } from '../feedback/pattern-detector.js';
import {
  recordGeneration,
...
import type { IGeneration, ICodePattern } from '../feedback/types.js';
